#
    ...
    Kết nối Cổng thanh toán VNPAY · Cổng thanh toán VNPAY
...
* Tham số: vnp_Version
  * Kiểu dữ liệu: Alphanumeric[1,8]
  * Bắt buộc/Tùy chọn: Bắt buộc
  * Mô tả: Phiên bản api mà merchant kết nối. Phiên bản hiện tại là : 2.1.0
* Tham số: vnp_Command
  * Kiểu dữ liệu: Alpha[1,16]
  * Bắt buộc/Tùy chọn: Bắt buộc
  * Mô tả: Mã API sử dụng, mã cho giao dịch thanh toán là: pay
* Tham số: vnp_TmnCode
  * Kiểu dữ liệu: Alphanumeric[8]
  * Bắt buộc/Tùy chọn: Bắt buộc
  * Mô tả: Mã website của merchant trên hệ thống của VNPAY. Ví dụ: 2QXUI4J4
* Tham số: vnp_Amount
  * Kiểu dữ liệu: Numeric[1,12]
  * Bắt buộc/Tùy chọn: Bắt buộc
  * Mô tả:   Số tiền thanh toán. Số tiền không mang các ký tự phân tách thập phân, phần nghìn, ký tự tiền tệ. Để gửi số tiền thanh toán là 10,000 VND (mười nghìn VNĐ) thì merchant cần nhân thêm 100 lần (khử phần thập phân), sau đó gửi sang VNPAY là: 1000000
* Tham số: vnp_BankCode
  * Kiểu dữ liệu: Alphanumeric[3,20]
  * Bắt buộc/Tùy chọn: Tùy chọn
  * Mô tả: Mã phương thức thanh toán, mã loại ngân hàng hoặc ví điện tử thanh toán.                 Nếu không gửi sang tham số này, chuyển hướng người dùng sang VNPAY chọn phương thức thanh toán.                Lưu ý:                Các mã loại hình thức thanh toán lựa chọn tại website-ứng dụng của merchant                 vnp_BankCode=VNPAYQRThanh toán quét mã QR                vnp_BankCode=VNBANKThẻ ATM - Tài khoản ngân hàng nội địa                vnp_BankCode=INTCARDThẻ thanh toán quốc tế
* Tham số: vnp_CreateDate
  * Kiểu dữ liệu: Numeric[14]
  * Bắt buộc/Tùy chọn: Bắt buộc
  * Mô tả: Là thời gian phát sinh giao dịch định dạng yyyyMMddHHmmss (Time zone GMT+7) Ví dụ: 20220101103111
* Tham số: vnp_CurrCode
  * Kiểu dữ liệu: Alpha[3]
  * Bắt buộc/Tùy chọn: Bắt buộc
  * Mô tả: Đơn vị tiền tệ sử dụng thanh toán. Hiện tại chỉ hỗ trợ VND
* Tham số: vnp_IpAddr
  * Kiểu dữ liệu: Alphanumeric[7,45]
  * Bắt buộc/Tùy chọn: Bắt buộc
  * Mô tả: Địa chỉ IP của khách hàng thực hiện giao dịch. Ví dụ: 13.160.92.202
* Tham số: vnp_Locale
  * Kiểu dữ liệu: Alpha[2,5]
  * Bắt buộc/Tùy chọn: Bắt buộc
  * Mô tả: Ngôn ngữ giao diện hiển thị. Hiện tại hỗ trợ Tiếng Việt (vn), Tiếng Anh (en)
* Tham số: vnp_OrderInfo
  * Kiểu dữ liệu: Alphanumeric[1,255]
  * Bắt buộc/Tùy chọn: Bắt buộc
  * Mô tả: Thông tin mô tả nội dung thanh toán quy định dữ liệu gửi sang VNPAY (Tiếng Việt không dấu và không bao gồm các ký tự đặc biệt)        Ví dụ: Nap tien cho thue bao 0123456789. So tien 100,000 VND
* Tham số: vnp_OrderType
  * Kiểu dữ liệu: Alpha[1,100]
  * Bắt buộc/Tùy chọn: Bắt buộc
  * Mô tả: Mã danh mục hàng hóa. Mỗi hàng hóa sẽ thuộc một nhóm danh mục do VNPAY quy định. Xem thêm bảng Danh mục hàng hóa
* Tham số: vnp_ReturnUrl
  * Kiểu dữ liệu: Alphanumeric[10,255]
  * Bắt buộc/Tùy chọn: Bắt buộc
  * Mô tả: URL thông báo kết quả giao dịch khi Khách hàng kết thúc thanh toán. Ví dụ: <https://domain.vn/VnPayReturn>
* Tham số: vnp_ExpireDate
  * Kiểu dữ liệu: Numeric[14]
  * Bắt buộc/Tùy chọn: Bắt buộc
  * Mô tả: Thời gian hết hạn thanh toán GMT+7, định dạng: yyyyMMddHHmmss
* Tham số: vnp_TxnRef
  * Kiểu dữ liệu: Alphanumeric[1,100]
  * Bắt buộc/Tùy chọn: Bắt buộc
  * Mô tả: Mã tham chiếu của giao dịch tại hệ thống của merchant. Mã này là duy nhất dùng để phân biệt các đơn hàng gửi sang VNPAY. Không được trùng lặp trong ngày. Ví dụ: 23554
* Tham số: vnp_SecureHash
  * Kiểu dữ liệu: Alphanumeric[32,256]
  * Bắt buộc/Tùy chọn: Bắt buộc
  * Mô tả: Mã kiểm tra (checksum) để đảm bảo dữ liệu của giao dịch không bị thay đổi trong quá trình chuyển từ merchant sang VNPAY. Việc tạo ra mã này phụ thuộc vào cấu hình của merchant và phiên bản api sử dụng. Phiên bản hiện tại hỗ trợ SHA256, HMACSHA512.
...
* Tham số: vnp_Amount
  * Kiểu dữ liệu: Numeric[1,12]
  * Bắt buộc/Tùy chọn: Bắt buộc
  * Mô tả: Số tiền thanh toán. VNPAY phản hồi số tiền nhân thêm 100 lần.
* Tham số: vnp_BankCode
  * Kiểu dữ liệu: Alphanumeric[3,20]
  * Bắt buộc/Tùy chọn: Bắt buộc
  * Mô tả: Mã Ngân hàng thanh toán. Ví dụ: NCB
* Tham số: vnp_BankTranNo
  * Kiểu dữ liệu: Alphanumeric[1,255]
  * Bắt buộc/Tùy chọn: Tùy chọn
  * Mô tả: Mã giao dịch tại Ngân hàng. Ví dụ: NCB20170829152730
* Tham số: vnp_CardType
  * Kiểu dữ liệu: Alpha[2,20]
  * Bắt buộc/Tùy chọn: Tùy chọn
  * Mô tả: Loại tài khoản/thẻ khách hàng sử dụng:ATM,QRCODE
* Tham số: vnp_PayDate
  * Kiểu dữ liệu: Numeric[14]
  * Bắt buộc/Tùy chọn: Tùy chọn
  * Mô tả: Thời gian thanh toán. Định dạng: yyyyMMddHHmmss
* Tham số: vnp_OrderInfo
  * Kiểu dữ liệu: Alphanumeric[1,255]
  * Bắt buộc/Tùy chọn: Bắt buộc
  * Mô tả: Thông tin mô tả nội dung thanh toán (Tiếng Việt, không dấu). Ví dụ: **Nap tien cho thue bao 0123456789. So tien 100,000 VND**
* Tham số: vnp_TransactionNo
  * Kiểu dữ liệu: Numeric[1,15]
  * Bắt buộc/Tùy chọn: Bắt buộc
  * Mô tả: Mã giao dịch ghi nhận tại hệ thống VNPAY. Ví dụ: 20170829153052
* Tham số: vnp_ResponseCode
  * Kiểu dữ liệu: Numeric[2]
  * Bắt buộc/Tùy chọn: Bắt buộc
  * Mô tả: Mã phản hồi kết quả thanh toán. Quy định mã trả lời 00 ứng với kết quả Thành công cho tất cả các API. Tham khảo thêm tại bảng mã lỗi
* Tham số: vnp_TransactionStatus
  * Kiểu dữ liệu: Numeric[2]
  * Bắt buộc/Tùy chọn: Bắt buộc
  * Mô tả: Mã phản hồi kết quả thanh toán. Tình trạng của giao dịch tại Cổng thanh toán VNPAY.            -00: Giao dịch thanh toán được thực hiện thành công tại VNPAY            -Khác 00: Giao dịch không thành công tại VNPAY            Tham khảo thêm tại bảng mã lỗi
* Tham số: vnp_TxnRef
  * Kiểu dữ liệu: Alphanumeric[1,100]
  * Bắt buộc/Tùy chọn: Bắt buộc
  * Mô tả: Giống mã gửi sang VNPAY khi gửi yêu cầu thanh toán. Ví dụ: 23554
* Tham số: vnp_SecureHash
  * Kiểu dữ liệu: Alphanumeric[32,256]
  * Bắt buộc/Tùy chọn: Bắt buộc
  * Mô tả: Mã kiểm tra (checksum) để đảm bảo dữ liệu của giao dịch không bị thay đổi trong quá trình chuyển từ VNPAY về Website TMĐT.              Cần kiểm tra đúng checksum khi bắt đầu xử lý yêu cầu (trước khi thực hiện các yêu cầu khác)
...
[Giống với tham số gửi về địa chỉ IPN URL](about:/apis/docs/thanh-toan-pay/pay.html#danh-s%C3%A1ch-tham-s%E1%BB%91-1)
...
* Mã lỗi: Bảng mã lỗi vnp_TransactionStatus
  * Mô tả:
* Mã lỗi: 00
  * Mô tả: Giao dịch thành công
* Mã lỗi: 01
  * Mô tả: Giao dịch chưa hoàn tất
* Mã lỗi: 02
  * Mô tả: Giao dịch bị lỗi
* Mã lỗi: 04
  * Mô tả: Giao dịch đảo (Khách hàng đã bị trừ tiền tại Ngân hàng nhưng GD chưa thành                 công ở VNPAY)
* Mã lỗi: 05
  * Mô tả: VNPAY đang xử lý giao dịch này (GD hoàn tiền)
* Mã lỗi: 06
  * Mô tả: VNPAY đã gửi yêu cầu hoàn tiền sang Ngân hàng (GD hoàn tiền)
* Mã lỗi: 07
  * Mô tả: Giao dịch bị nghi ngờ gian lận
* Mã lỗi: 09
  * Mô tả: GD Hoàn trả bị từ chối

* Mã lỗi: vnp_ResponseCode VNPAY phản hồi qua IPN và Return URL:
  * Mô tả:
* Mã lỗi: 00
  * Mô tả: Giao dịch thành công
* Mã lỗi: 07
  * Mô tả: Trừ tiền thành công. Giao dịch bị nghi ngờ (liên quan tới lừa đảo, giao dịch bất thường).
* Mã lỗi: 09
  * Mô tả: Giao dịch không thành công do: Thẻ/Tài khoản của khách hàng chưa đăng ký dịch vụ InternetBanking tại ngân hàng.
* Mã lỗi: 10
  * Mô tả: Giao dịch không thành công do: Khách hàng xác thực thông tin thẻ/tài khoản không đúng quá 3 lần
* Mã lỗi: 11
  * Mô tả: Giao dịch không thành công do: Đã hết hạn chờ thanh toán. Xin quý khách vui lòng thực hiện lại giao dịch.
* Mã lỗi: 12
  * Mô tả: Giao dịch không thành công do: Thẻ/Tài khoản của khách hàng bị khóa.
* Mã lỗi: 13
  * Mô tả: Giao dịch không thành công do Quý khách nhập sai mật khẩu xác thực giao dịch (OTP). Xin quý khách vui lòng thực hiện lại giao dịch.
* Mã lỗi: 24
  * Mô tả: Giao dịch không thành công do: Khách hàng hủy giao dịch
* Mã lỗi: 51
  * Mô tả: Giao dịch không thành công do: Tài khoản của quý khách không đủ số dư để thực hiện giao dịch.
* Mã lỗi: 65
  * Mô tả: Giao dịch không thành công do: Tài khoản của Quý khách đã vượt quá hạn mức giao dịch trong ngày.
* Mã lỗi: 75
  * Mô tả: Ngân hàng thanh toán đang bảo trì.
* Mã lỗi: 79
  * Mô tả: Giao dịch không thành công do: KH nhập sai mật khẩu thanh toán quá số lần quy định. Xin quý khách vui lòng thực hiện lại giao dịch
* Mã lỗi: 99
  * Mô tả: Các lỗi khác (lỗi còn lại, không có trong danh sách mã lỗi đã liệt kê)
