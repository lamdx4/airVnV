 ...
 */
export const mapConversationDtoToModel = (
  dto: any,
  ...
  const otherParticipantName =
    ...
    dto.participants?.find((p: any) => p.userId !== currentUserId)
      ?.displayName ||
    "Unknown User";
  const otherParticipantAvatar =
    dto.otherParticipantAvatar ||
  ...
  return {
    ...
    otherLastReadMessageId:
      dto.otherLastReadMessageId || dto.OtherLastReadMessageId,
...
export const mapMessageDtoToModel = (dto: any): ChatMessage => {
  ...
  return {
    ...
    messageType:
      typeof dto.messageType === "string"
        ? dto.messageType
        : dto.messageType === 1 || dto.isSystemMessage
          ? "System"
          : dto.messageType === 2
            ? "Image"
            : "Text",
