...
export const ChatContainer: React.FC = () => {
  ...
  const [activeCallParticipant, setActiveCallParticipant] = useState<{
    id: string;
    name: string;
    avatar?: string;
  } | null>(null);
  ...
  useEffect(() => {
    if (
      ...
      setTimeout(() => setActiveCallParticipant(null), 300);
    }
      ...
      <div className="h-full md:rounded-[28px] border-x md:border border-[#ebebeb] bg-white overflow-hidden flex shadow-sm relative">
              ...
              >
                <div className="p-8 bg-white rounded-full shadow-xs border border-[#ebebeb]">
                  <Icon
                    ...
                    className="text-6xl text-[#b0b0b0]"
                  />
                </div>
                <div className="space-y-2">
                  <h2 className="text-[18px] font-semibold text-[#222222] tracking-tight">
                    Select a message
                  </h2>
        ...
        {activeCallParticipant && (
          <CallModal
            ...
            otherParticipantName={activeCallParticipant.name}
            otherParticipantAvatar={activeCallParticipant.avatar}
